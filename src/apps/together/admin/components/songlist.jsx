   ...
   if (this.props.user) {
     return (
        ...
        <div className="collapsible-header">
          <a className="btn-small waves-effect waves-light"><i className="small material-icons green-text" onClick={this.handleDeleteSong}>delete</i></a>
          <a className="btn-small waves-effect waves-light"><i className="small material-icons green-text" onClick={this.handleAddSong}>playlist_add</i></a>
          { songName }&nbsp; &nbsp;
          ...
          <a className="btn-small waves-effect waves-light"><i className="small material-icons teal-text" onClick={this.handleDownVote}>thumb_down</i></a>
        </div>
     	<div className="collapsible-body">
        <p>Artist: { artist }<br/>Album: { album }<br/>Votes: { voteCount }</p>
      </div>
      </li>
     );
   }
